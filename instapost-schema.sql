...
CREATE TABLE posts (
  ...
  username VARCHAR(30) REFERENCES users(username) ON UPDATE CASCADE NOT NULL
);

CREATE TABLE follows (
  username_being_followed VARCHAR(30) REFERENCES users(username) ON UPDATE CASCADE NOT NULL,
  username_following VARCHAR(30) REFERENCES users(username) ON UPDATE CASCADE NOT NULL,
